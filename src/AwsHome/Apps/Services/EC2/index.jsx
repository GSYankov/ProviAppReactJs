    ...
    return(<div className="col-lg-5">
        ...
        <div id="ec2_details">
            <div className="form-group">
                <label htmlFor="app_tier">Application Tier<span className="field-required">*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="os">Operating System<span className="field-required">*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="ami">Amazon Machine Image<span className="field-required">*</span></label>
                <select className="form-control" id="ami" name="ami" required="">
                </select>
            </div>

            <div className="form-group">
                <label htmlFor="instance_type">Instance Type<span className="field-required">*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="domain">Domain<span className="field-required">*</span></label>
            ...
            <label className="form-check-label" htmlFor="change_saml_domain_check">Change the default SAML Domain</label>
            </div> --> */}

            <div className="form-group">
                <label htmlFor="saml_domain">SAML Domain<span className="field-required">*</span></label>
            ...
            {/* <!-- <div className="form-group">
                <label htmlFor="disk_size">Disk Size On Root Partition<span className='field-required'>*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="subnet_id">Subnet ID<span className="field-required">*</span></label>
            ...
            <div className="form-check">
                ...
                <label className="form-check-label fr-check" htmlFor="change_sgs" >Add common
                    Security
                    Group</label>
            </div>

            <div className="form-group hidden" id="sg_id_group">
                <label htmlFor="sg_id">Security Group ID<span className="field-required">*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="multiple_machines">Multiple Machines<span className="field-required">*</span></label>
                <div className="form-check">
                    <input type="checkbox" className="form-check-input" id="multiple_machines_check" />
                    <label className="form-check-label" htmlFor="multiple_machines_check">Create multiple machines with
                        the
            ...
            {/* <!-- <div className="form-check">
                ...
                <label className="form-check-label" htmlFor="multiple_disks_check">Add additional disks</label>
            </div> --> */}
            ...
            <div id="tags">
                ...
                <div className="form-group">
                    {/* <!-- Request --> */}
                    <label htmlFor="puppet_role">Puppet Role<span className="field-required">*</span></label>
                ...
                <div className="form-group">
                    <label htmlFor="puppet_managed">Puppet Managed<span className="field-required">*</span></label>
                ...
                <div className="form-group">
                    {/* <!-- Request --> */}
                    <label htmlFor="cpm_backup">CPM Backup<span className="field-required">*</span></label>
                ...
                <div className="form-group hidden" id="db_type_div">
                    <label htmlFor="db_type">Database Type<span className="field-required">*</span></label>
